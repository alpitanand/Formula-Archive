...
public class Maths extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    private DrawerLayout mpDrawerLayout;
    private Toolbar toolbar;
    private ActionBarDrawerToggle aToggle;
    private RecyclerView recyclerView;
    private Maths_recycler maths_recycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maths_recycler = new Maths_recycler(getApplicationContext());
        final LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(maths_recycler);
        aToggle.syncState();
        setTitle(R.string.Mathse);
