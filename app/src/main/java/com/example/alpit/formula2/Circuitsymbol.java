...
public class Circuitsymbol extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circuitsymbol);
        ...
        checkBox12.setChecked(getAsp("checkbox44"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/symbol.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check44) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox44", check44);
