...
public class Interference extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox8"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Interfernceanddiffractionoflights.html");
