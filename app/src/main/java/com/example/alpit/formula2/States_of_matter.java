...
public class States_of_matter extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox63"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Stateofmatter.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check63) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox63", check63);
