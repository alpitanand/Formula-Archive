...
public class Thermodynamics extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox13"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Thermodynamics.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check13) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox13", check13);
