...
public class Equilibrium extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox65"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/equli.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check65) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox65", check65);
