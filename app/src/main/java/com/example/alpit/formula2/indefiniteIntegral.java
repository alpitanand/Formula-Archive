...
public class indefiniteIntegral extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indefinite_integral);
        ...
        checkBox12.setChecked(getAsp("checkbox25"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Indefiniteintegrals.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check25) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox25", check25);
