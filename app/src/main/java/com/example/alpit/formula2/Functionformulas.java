...
public class Functionformulas extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_functionformulas);
        ...
        checkBox12.setChecked(getAsp("checkbox22"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/functionsformulas.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check22) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox22", check22);
