...
public class definiteIntegral extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_definite_integral2);
        ...
        checkBox12.setChecked(getAsp("checkbox26"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/definite.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check26) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox26", check26);
