...
public class Electroniccircuit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electroniccircuit);
        ...
        checkBox12.setChecked(getAsp("checkbox46"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/ececiruit.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check46) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox46", check46);
