...
public class Limits extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox24"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/limitsandderivative.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check24) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox24", check24);
