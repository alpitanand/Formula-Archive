...
public class Ohmslaw extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox42"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/ohmslaw.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check42) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox42", check42);
