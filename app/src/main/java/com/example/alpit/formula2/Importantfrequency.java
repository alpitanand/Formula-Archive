...
public class Importantfrequency extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_importantfrequency);
        ...
        checkBox12.setChecked(getAsp("checkbox49"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/impfreq.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check49) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox49", check49);
