...
public class Abbreviation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox41"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/abbreviations.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check41) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox41", check41);
