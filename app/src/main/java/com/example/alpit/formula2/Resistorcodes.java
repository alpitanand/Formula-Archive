...
public class Resistorcodes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resistorcodes);
        ...
        checkBox12.setChecked(getAsp("checkbox43"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/resistorcode.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check43) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox43", check43);
