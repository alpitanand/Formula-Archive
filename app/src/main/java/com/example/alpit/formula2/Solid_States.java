...
public class Solid_States extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solid__states);
        ...
        checkBox12.setChecked(getAsp("checkbox66"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/solildstate.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check66) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox66", check66);
