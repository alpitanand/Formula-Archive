...
public class Algebricformulas extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algebricformulas);
        ...
        checkBox12.setChecked(getAsp("checkbox21"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/algebricformulas.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check21) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox21", check21);
