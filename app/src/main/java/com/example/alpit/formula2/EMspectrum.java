...
public class EMspectrum extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emspectrum);
        ...
        checkBox12.setChecked(getAsp("checkbox47"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/emspec.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check47) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox47", check47);
