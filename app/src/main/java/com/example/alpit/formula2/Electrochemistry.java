...
public class Electrochemistry extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox68"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Electrochemistry.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check68) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox68", check68);
