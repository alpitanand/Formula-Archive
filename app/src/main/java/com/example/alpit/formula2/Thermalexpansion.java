...
public class Thermalexpansion extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox12"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Thermalexpansion.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check12) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox12", check12);
