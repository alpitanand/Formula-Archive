...
public class Modernphysics extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox11"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Modernphysics.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check11) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox11", check11);
