...
public class Basic_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox61"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/basic_concepts.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check61) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox61", check61);
