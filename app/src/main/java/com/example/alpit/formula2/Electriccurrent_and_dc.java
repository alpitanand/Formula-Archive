...
public class Electriccurrent_and_dc extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electriccurrent_and_dc);
        ...
        checkBox.setChecked(getAsp("checkbox15"));
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check15) {
        if (checkBox.isChecked()) {

            saveInSp("checkbox15", check15);
