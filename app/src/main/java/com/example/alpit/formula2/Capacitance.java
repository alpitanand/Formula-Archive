...
public class Capacitance extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox.setChecked(getAsp("checkbox14"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Capacitance.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check14) {
        if (checkBox.isChecked()) {

            saveInSp("checkbox14", check14);
