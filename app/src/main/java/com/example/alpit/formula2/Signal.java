...
public class Signal extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox51"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/signal.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check51) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox51", check51);
