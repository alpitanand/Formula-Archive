...
public class Electric_force_field extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_force_field);
        ...
        checkBox12.setChecked(getAsp("checkbox9"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Electricharge_force_field.html");
