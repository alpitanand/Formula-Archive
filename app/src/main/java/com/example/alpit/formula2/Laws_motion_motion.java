...
public class Laws_motion_motion extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laws_motion_motion);
        ...
        checkBox12.setChecked(getAsp("checkbox1"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Laws_of_motion.html");
