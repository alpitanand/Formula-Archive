...
public class Most extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void setupViewPager(ViewPager viewPager) {
        Triangle.Adapter adapter = new Triangle.Adapter(getSupportFragmentManager());
        adapter.addFragment(new Algebra(), "Algebra");
        adapter.addFragment(new Functions(), "Functions");
        adapter.addFragment(new Geometry(), "Geometry");
        adapter.addFragment(new derivatives(), "Derivatives");
        adapter.addFragment(new Integrals(), "Integrals");
        adapter.addFragment(new mseries(), "Series");
