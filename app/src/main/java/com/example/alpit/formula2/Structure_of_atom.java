...
public class Structure_of_atom extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_structure_of_atom);
        ...
        checkBox12.setChecked(getAsp("checkbox62"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/atom.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check62) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox62", check62);
