...
public class Greeksymbol extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox48"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/greek.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check48) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox48", check48);
