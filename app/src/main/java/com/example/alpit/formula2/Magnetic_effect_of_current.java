...
public class Magnetic_effect_of_current extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magnetic_effect_of_current);
        ...
        checkBox = (CheckBox) findViewById(R.id.fav1);
        checkBox.setChecked(getAsp("checkbox16"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Electriccurrent_and dc.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check16) {
        if (checkBox.isChecked()) {

            saveInSp("checkbox16", check16);
