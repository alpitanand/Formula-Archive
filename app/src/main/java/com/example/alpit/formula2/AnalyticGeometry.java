...
public class AnalyticGeometry extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analytic_geometry);
        ...
        checkBox12.setChecked(getAsp("checkbox23"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Analyticgeometry.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check23) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox23", check23);
