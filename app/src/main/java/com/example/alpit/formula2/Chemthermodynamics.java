...
public class Chemthermodynamics extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemthermodynamics);
        ...
        checkBox12.setChecked(getAsp("checkbox70"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/Thermodyna.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check70) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox70", check70);
