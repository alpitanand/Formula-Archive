...
public class Series extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox27"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/series.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check27) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox27", check27);
