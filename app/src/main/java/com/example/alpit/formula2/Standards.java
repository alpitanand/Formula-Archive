...
public class Standards extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox52"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/standerd.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check52) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox52", check52);
