...
public class Solutions extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox67"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/solution.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check67) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox67", check67);
