...
public class laplace extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox12.setChecked(getAsp("checkbox29"));
        ...
        gwebView.loadUrl("file:///android_asset/mathscribe/laplace.html");
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean check29) {
        if (checkBox12.isChecked()) {

            saveInSp("checkbox29", check29);
